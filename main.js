(function(w) {
  ...
  function getDisplayTime(date) {
    ...
    displayTime =
      [
        date.getHours() - (isPM && !isMidday ? 12 : 0),
    ...
    return events
      ...
      .map(function(node) {
        var initialTime = new Date(
          ...
          startTime = new Date(
            initialTime.setMinutes(initialTime.getMinutes() + node.start)
          ),
          endTime = new Date(
            initialTime.setMinutes(initialTime.getMinutes() + durationMin)
          );
